...
const mockAuditLogs = [
  {
    id: 1,
    action: "Reserva Bloqueada",
    details: "La agencia 'Galapagos Dreams' bloqueó 4 cupos en Galaxy I.",
    user: "Agencia (Galapagos Dreams)",
  ...
  },
  {
    ...
    details: "Se confirmó la reserva RES-2026-8942 y se generó el Voucher PDF.",
    user: "Sistema (Auto)",
    type: "success",
  ...
  {
    id: 3,
    action: "Cupos Modificados",
    details: "El capitán del Sea Wolf redujo la capacidad máxima de 16 a 12.",
    user: "Operador (Sea Wolf)",
    type: "info",
  ...
  },
  {
    ...
    details: "Reserva RES-2026-8800 expiró sin pago y fue cancelada automáticamente.",
    user: "Sistema (Auto)",
    type: "error",
  ...
  },
  {
    ...
    details: "El administrador activó el envío de vouchers por WhatsApp.",
    user: "Admin (Root)",
    type: "info",
    timestamp: "12 Oct 2026, 11:20 AM",
  },
];

// Helper para iconos y colores según el tipo
    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-1">Registro inmutable de todas las acciones del sistema.</p>
        </div>
      </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-slate-50/50 dark:bg-slate-900/50 border-b border-slate-200 dark:border-slate-800">
                ...
                <th className="p-4 text-xs font-bold text-slate-500 uppercase tracking-widest whitespace-nowrap">Usuario</th>
                <th className="p-4 text-xs font-bold text-slate-500 uppercase tracking-widest whitespace-nowrap text-right">Fecha y Hora</th>
              </tr>
            </thead>
              ...
              {mockAuditLogs.map((log) => {
                ...
                return (
                  <tr key={log.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/20 transition-colors group">
                    ...
                    <td className="p-4 whitespace-nowrap">
                      <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg bg-slate-100 dark:bg-slate-800 text-xs font-medium text-slate-700 dark:text-slate-300">
                        {log.user.includes("Admin") && <ShieldAlert className="w-3.5 h-3.5" />}
                        {log.user}
                      </span>
                    </td>
