    ...
    <div className="max-w-7xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          type="button"
          className="w-full sm:w-auto flex items-center justify-center gap-2 px-5 py-3 bg-primary text-white font-medium rounded-xl hover:bg-blue-600 transition-all duration-300 ease-in-out shadow-lg shadow-primary/30 hover:scale-[1.02] active:scale-95"
        >
      ...
      <div className="space-y-4 pt-4">
        {mockVessels.map((vessel) => {
          ...
          return (
            <div
              key={vessel.id}
              className="glass p-5 rounded-2xl grid grid-cols-1 sm:grid-cols-12 gap-6 items-center transition-all duration-300 hover:shadow-lg dark:hover:shadow-primary/5 hover:-translate-y-0.5 border border-slate-200/60 dark:border-slate-800/60"
            >
              <div className="sm:col-span-6 md:col-span-5 flex items-center gap-5 min-w-0">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-1">
                    ...
                    <span className={`shrink-0 px-2.5 py-1 rounded-full text-[11px] sm:text-xs font-bold tracking-wide uppercase ${badgeColor}`}>
                      {statusText}
                    </span>
                  </div>
              ...
              <div className="sm:col-span-3 md:col-span-4 flex sm:justify-center items-center gap-3 px-4 sm:border-l border-slate-100 dark:border-slate-800">
                ...
                <div>
                  ...
                  <div className="text-xs text-slate-500 dark:text-slate-400 font-medium mt-1">pasajeros máx.</div>
                </div>
              </div>
              ...
              <div className="sm:col-span-3 md:col-span-3 flex items-center justify-end gap-2 pt-4 sm:pt-0 border-t sm:border-t-0 border-slate-100 dark:border-slate-800">
                ...
                <button type="button" aria-label={`Eliminar ${vessel.name}`} className="w-11 h-11 shrink-0 flex items-center justify-center text-slate-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-950/30 rounded-xl transition-all duration-300 ease-in-out active:scale-95">
