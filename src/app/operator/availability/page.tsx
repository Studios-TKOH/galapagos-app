        ...
        {departures.map((dep) => (
          ...
          >
            <div className="flex justify-between items-start mb-4">
              ...
              {dep.status === 'full' && (
                <span className="px-2.5 py-1 bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400 text-xs font-black uppercase tracking-wider rounded-lg">
                  Lleno
                </span>
              )}
            </div>
            ...
            <div className="flex items-center justify-between bg-slate-50 dark:bg-slate-800/50 p-3 rounded-2xl">
              ...
              <div className="flex items-center gap-2">
                <button 
                  ...
                  aria-label={`Quitar un cupo de ${dep.routeName}`}
                ...
                <button 
                  ...
                  aria-label={`Añadir un cupo a ${dep.routeName}`}
                  className="w-14 h-14 rounded-2xl bg-white dark:bg-slate-800 shadow-sm border border-slate-200 dark:border-slate-700 flex items-center justify-center text-slate-600 dark:text-slate-300 disabled:opacity-50 hover:bg-slate-100 dark:hover:bg-slate-700 active:scale-95 transition-all duration-300 ease-in-out"
                >
