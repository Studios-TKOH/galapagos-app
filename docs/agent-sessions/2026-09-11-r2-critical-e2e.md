...
validation_results:
  - "static syntax checks prepared before PR"
  - "runtime E2E result must come from Critical E2E on the PR"
docs_updated:
  - README.md
  - BASELINE.md
  - CHANGELOG.md
...
- El PR se abre únicamente después del commit agrupado para evitar CI por cada edición intermedia.
